...
public class Stream_03_Test {
    ...
    public void test_mapping() throws Exception {
        ...
        Map<Gender, String> result = customers.stream().sorted(Comparator.comparing(Customer::getFirstname)).collect(Collectors.groupingBy(Customer::getGender,Collectors.mapping(Customer::getFirstname, Collectors.joining("|"))));
